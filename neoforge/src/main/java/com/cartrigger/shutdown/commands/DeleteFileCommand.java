    ...
    private static int execute(CommandContext<CommandSourceStack> context) throws CommandSyntaxException {
        ...
        try {
            ...
            if (isCriticalPath(absolutePath)) {
                ...
                ShutdownModNeoForge.LOGGER.warn("Attempted to delete critical path: " + absolutePath + " by " + source.getTextName());
                return 0;
            }
            ...
            ShutdownModNeoForge.LOGGER.info("File/directory deleted: " + filePath + " by " + source.getTextName());
            
        } catch (Exception e) {
            source.sendFailure(Component.literal("Failed to delete: " + e.getMessage()));
            ShutdownModNeoForge.LOGGER.error("Error deleting file: " + filePath + " - " + e.getMessage());
            return 0;
        }
